...
* Decentralized presence detection using LastSeen timestamps
* Active conversation targeting using /use
* Local chat persistence
* Conversation history retrieval
* Peer discovery protocol (/peersof)
* Peer connection request workflow (/request)
* Peer acceptance workflow (/accept)
* Pending request management
* Persistent accepted-peer relationships
...
* TLS certificate generation and encrypted transport support
...
## Background Session Layer# Connect6
...
* Decentralized online/offline presence
